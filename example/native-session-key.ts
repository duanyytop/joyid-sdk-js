...
import { addressFromPrivateKey, pemToKey } from '../src/utils'
...
const run = async () => {
  ...
  await sendCKBFromNativeSessionLock(collector, MAIN_PRIVATE_KEY, rsaKey, fromAddress, TO_ADDRESS, BigInt(20000000000))
}
