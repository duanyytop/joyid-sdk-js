...
import { addressFromPrivateKey, pemToKey, pubkeyFromPrivateKey, SigAlg } from '../src/utils'
...
const run = async () => {
  ...
  await sendCKBFromSubkeySessionLock(servicer, SUB_PRIVATE_KEY, subkeyAlgIndex, rsaKey, fromAddress, TO_ADDRESS, BigInt(20000000000), SigAlg.Secp256k1)
}
